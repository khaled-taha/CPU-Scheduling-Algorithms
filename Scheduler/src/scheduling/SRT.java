 ...
 */
public class SRT extends AllocStrat {
    ...
    public void run() {
        ...
        /*Sorting jobs by CPU time*/
        super.Jobs.sort((Job o1, Job o2) -> o1.getCpuTime() - o2.getCpuTime());
        ...
        while (this.remainigProcessToFinish != 0) {
            ...
            for (counter = 0; counter < this.ProcessesNum; counter++) {
                ...
                if ((this.Jobs.get(counter).getprocessArrivalTime() <= this.timeLine) &&
                    ...
                    Jobs.get(counter).setProcessCompletionTime(this.timeLine);
                    Jobs.get(counter).calculateWaitingTime();
